...
export const ApiEndpoints = {
  ...
  UPLOAD_PICTURE: API_URL + "/image/user"
}

export const AuthServerEndpoints = {
  ACCOUNT_API: process.env.REACT_APP_OAUTH_AUTHORITY_URL + "/realms/" + process.env.REACT_APP_OAUTH_REALM + "/account",
  USER: (userId:string) => process.env.REACT_APP_OAUTH_AUTHORITY_URL + "/admin/realms/" + process.env.REACT_APP_OAUTH_REALM + "/users/" + userId,
}
